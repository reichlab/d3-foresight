...
3. ~biweek~ denoting a unit of two regular weeks

All points can be represented using either standard JS Date objects or using
simple objects like shown:

#+BEGIN_SRC js
  {
    week: 20, // Use biweek for biweek point type
    year: 2016
  }
#+END_SRC
